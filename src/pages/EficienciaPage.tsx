...
export default function EficienciaPage() {
  ...
  return (
    <div>
      <GlobalFilters />
      <SectionHeader title="Eficiência — Ativos" subtitle="Gestão de ferramentas, equipamentos e tempo produtivo" icon={<Wrench className="h-5 w-5" />} />
                ...
                <tr key={f.id} className="border-b border-border/50 hover:bg-secondary/50 transition-colors">
                  ...
                  <td className="py-2.5 px-3 text-right">
                    <div className="flex justify-end gap-1">
                      <EditRecordDialog title="Editar Ativo" fields={fields} record={f} onSubmit={update} />
